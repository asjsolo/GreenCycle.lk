  ...
  const handleCalculate = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:4000/api/footprint/calculate",
        {
          method: "POST",
          headers: {
        ...
        <div className="plastic-calculator-container">
          ...
          {result !== null && (
            <div className="plastic-calculator-result-container">
              <p>
                Carbon Footprint: {result.carbonFootprint.toFixed(2)} kg CO2e
              </p>
          ...
          {showBreakdown && (
            <div className="plastic-calculator-breakdown-modal">
              ...
              <p>
                Your Eco Score is calculated based on your estimated daily usage
                of common single-use plastic items.
              </p>
              <p>
              ...
              <div className="plastic-calculator-eco-score-explanation">
                ...
                <p>
                  This score represents your environmental impact from the
                  plastic items you entered, on a scale of 0 to 100.
                </p>
                {result && result.points > 20 ? (
                  ...
                  <>
                    <p>
                      Your current score suggests a higher plastic footprint.
                      Here are some things you might consider to reduce your
                      impact:
                    </p>
                    <ul>
                      {bottles > 15 && (
                        <li>
                          Try to reduce your use of single-use plastic bottles.
                          Consider reusable water bottles.
                        </li>
                      )}
                      {bags > 40 && (
                        <li>
                          Opt for reusable shopping bags instead of single-use
                          plastic bags.
                        </li>
                      )}
                      {straws > 80 && (
                        <li>
                          Decline single-use plastic straws. If needed, use
                          reusable alternatives.
                        </li>
                      )}
                      {containers > 8 && (
                        <li>
                          Use reusable food containers instead of disposable
                          ones.
                        </li>
                      )}
                      {wrappers > 25 && (
                        <li>
                          Look for products with less packaging or reusable
                          wrapping options.
                        </li>
                      )}
                    </ul>
